...
if __name__ == '__main__':
    ...
    """
    This script takes a folder of ET data and DMI data and produces localizes the ETF files
    with DMI data.
    """
    ...
    localized_output = "test_files/localized_metric/"
    crs = 'EPSG_4329'

    for et_dir in et_dirs:
        et_files = glob.glob(et_dir + '/**/*_ETF.tif')
        
        ETRasterBuilder(et_files, localized_output, dmi_data_dir).localize_etf_data()
