...
if __name__ == '__main__': 
    ...
    username, _, password = nc.authenticators(host) 
    ...
    # datasetName = "LANDSAT 8, LANDSAT 9"
    datasetName = "landsat 9"
    ...
    spatialFilter =  {'filterType' : "mbr",
                        'lowerLeft' : {'latitude' : 54, 'longitude' : 8},
                        'upperRight' : { 'latitude' : 57, 'longitude' : 16}}
                     
    temporalFilter = {'start' : '2023-05-01', 'end' : '2023-06-01'}
